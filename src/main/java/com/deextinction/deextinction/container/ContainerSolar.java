...
public class ContainerSolar extends Container
{
	...
	public ContainerSolar(InventoryPlayer player, TileEntitySolar tileentity) 
	{
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) 
	{
		...
		if(slot != null && slot.getHasStack()) 
		{
			...
			{		
				...
				if(!SolarRecipes.getInstance().getSolarResult(stack1, slot1.getStack()).isEmpty())
				{
					if(!this.mergeItemStack(stack1, 0, 2, false)) 
					{
						return ItemStack.EMPTY;
					}
					else if(TileEntitySolar.isItemFuel(stack1))
					{

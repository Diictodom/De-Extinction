...
public class GuiCentrifuge  extends GuiContainer
{
	...
	private static final ResourceLocation TEXTURES = new ResourceLocation(Deextinction.MODID + ":textures/gui/centrifuge.png");
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		if(TileEntityCentrifuge.isBurning(tileentity))
		{

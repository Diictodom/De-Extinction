...
public class GuiMicroscope  extends GuiContainer
{
	...
	public GuiMicroscope(InventoryPlayer player, TileEntityMicroscope tileentity) 
	{
		super(new ContainerMicroscope(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		if(TileEntityMicroscope.isBurning(tileentity))
		{

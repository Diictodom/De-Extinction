...
{
	private static final ResourceLocation TEXTURES = new ResourceLocation(Deextinction.MODID + ":textures/gui/cleaningtable.png");
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		this.drawTexturedModalRect(this.guiLeft + 72, this.guiTop + 34, 176, 14, l + 1, 16);
	}

...
{
	private static final ResourceLocation TEXTURES = new ResourceLocation(Deextinction.MODID + ":textures/gui/eggmachine.png");
	private final InventoryPlayer player;
	private final TileEntityEggMachine tileentity;
	
	public GuiEggMachine(InventoryPlayer player, TileEntityEggMachine tileentity) 
	{
		super(new ContainerEggMachine(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		if(TileEntityEggMachine.isBurning(tileentity))
		{

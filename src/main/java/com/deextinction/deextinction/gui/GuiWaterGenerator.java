...
public class GuiWaterGenerator  extends GuiContainer
{
	...
	public GuiWaterGenerator(InventoryPlayer player, TileEntityWaterGenerator tileentity) 
	{
		super(new ContainerWaterGenerator(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		if(TileEntityWaterGenerator.isBurning(tileentity))
		{

...
{	
	private static final GeneratorRecipes INSTANCE = new GeneratorRecipes();
	private final Table<ItemStack, ItemStack, ItemStack> smeltingList = HashBasedTable.<ItemStack, ItemStack, ItemStack>create();
	private final Map<ItemStack, Float> experienceList = Maps.<ItemStack, Float>newHashMap();
	
	public static GeneratorRecipes getInstance()
	{
		return INSTANCE;
	}
	...
	{
		if(getGeneratorResult(input1, input2) != ItemStack.EMPTY) return;
		this.smeltingList.put(input1, input2, result);
		this.experienceList.put(result, Float.valueOf(experience));
	}
	
	public ItemStack getGeneratorResult(ItemStack input1, ItemStack input2) 
	{

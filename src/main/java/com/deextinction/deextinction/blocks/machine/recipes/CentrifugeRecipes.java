...
{	
	...
	public void addCentrifugeRecipe(ItemStack input1, ItemStack input2, ItemStack result, float experience) 
	{
	...
	public float getCentrifugeExperience(ItemStack stack)
	{

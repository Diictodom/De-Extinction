...
{	
	...
	public void addGrinderRecipe(ItemStack input1, ItemStack input2, ItemStack result, float experience) 
	{
	...
	public ItemStack getGrinderResult(ItemStack input1, ItemStack input2) 
	{

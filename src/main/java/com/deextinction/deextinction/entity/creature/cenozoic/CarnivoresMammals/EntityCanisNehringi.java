...
public class EntityCanisNehringi extends EntityBigCat
...
//	}
	...
	protected void initEntityAI()
	{
	    ...
	    this.targetTasks.addTask(1, new EntityCanisNehringi.AIHurtByTarget());
	    this.targetTasks.addTask(2, new EntityCanisNehringi.AIAttackPlayer());
		this.tasks.addTask(3, new EntityAIAttackMelee(this, 1.8D, true));
	...
	class AIAttackPlayer extends EntityAINearestAttackableTarget<EntityPlayer>
    {
        ...
        {
            super(EntityCanisNehringi.this, EntityPlayer.class, 20, true, true, (Predicate)null);
        }
	 ...
	 class AIHurtByTarget extends EntityAIHurtByTarget
	    {
	        ...
	        {
	            super(EntityCanisNehringi.this, false);
	        }

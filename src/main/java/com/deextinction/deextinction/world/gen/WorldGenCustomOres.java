...
public class WorldGenCustomOres implements IWorldGenerator {
	...
	private WorldGenerator permafrost_block;
	...
	public WorldGenCustomOres() {
	   ...
	   permafrost_block = new WorldGenMinable(DeexBlocks.PERMAFROST_BLOCK.getDefaultState(), 4, BlockMatcher.forBlock(Blocks.DIRT)); 
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
	    ...
	    case 0:
	        ...
	        runGenerator(permafrost_block, world, random, chunkX, chunkZ, 25, 57, 100, BiomeSnow.class);
    ...
    public void runGenerator(WorldGenerator gen, World world, Random rand, int chunkX, int chunkZ, int chance, int minHeight, int maxHeight, Class<?>... classes) {
        ...
        for(int i = 0; i < chance; i++) {
            ...
            if(classesList.contains(biome) || classes.length == 0) gen.generate(world, rand,pos);
